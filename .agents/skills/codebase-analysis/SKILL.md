...
description: "Deep codebase analysis using MCP servers â€” combines fallow (static analysis), graphify (knowledge graph), gitnexus (git intelligence), and codebase-memory (persistent understanding) for comprehensive code health assessment."
---
...
- Run `codebase-memory-mcp` â†’ `index_repository` to ensure the project is indexed
...
1. **Code Pollution** â€” Dead code percentage, unused exports count, orphaned modules
2. **Complexity Hotspots** â€” Top 10 most complex files/functions
3. **Duplication** â€” Duplicate code blocks with locations
4. **Architecture Health** â€” Circular dependencies, boundary violations
5. **Churn Analysis** â€” Files with highest change frequency (potential instability)
6. **Recommendations** â€” Prioritized list of improvements
